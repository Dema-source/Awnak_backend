...
/**
 * Service layer for handling business logic related to the "ApplicationRepositoryInterface" repository.
 */
class ApplicationService
{
     ...
     *
     * @param \App\Repositories\Interfaces\ApplicationRepositoryInterface $repository
     */
